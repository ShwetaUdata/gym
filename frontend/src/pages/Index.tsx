    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
            <span className="gradient-text">US Gymnasium</span>
            <br />
        ...
        <div className="container mx-auto">
          <Card variant="gradient" className="p-8 md:p-12 text-center border-primary/20 glow">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto mb-8">
              Join US Gymnasium today and take the first step towards a healthier, 
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="container mx-auto text-center text-muted-foreground text-sm">
          <p>© 2021 US Gymnasium. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
