      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-center pb-4">
            <div className="space-y-2 text-center"><br/>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { key: 'cardio', label: 'Cardio', icon: Heart, price: '₹2000/mo' },
                { key: 'crossfit', label: 'Crossfit', icon: Zap, price: '₹2500/mo' },
                { key: 'pt', label: 'PT', icon: UserCheck, price: '₹15,000/mo', description: 'Note(included on a month-to-month basis, not session-wise)' },
              ].map(({ key, label, icon: Icon, price, description }) => (
                <label
                  key={key}
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <ol className="list-decimal list-inside space-y-2">
                <li>Membership fee are non-refundable once paid.</li>
                <li>Gym timings: Morning 6:00 AM - 11:00 AM, Evening 5:00 PM - 10:00 PM.</li>
